...
async def create_loot_resolver(_, info, raid_id, item_id):
    """

    :param _: param info:
    :param raid_id: param item_id:
    :param info:
    :param item_id:
...
@convert_kwargs_to_snake_case
async def update_loot_resolver(_, info, id, raid_id, item_id, auction_id):
    """

    :param _: param info:
    :param id: param raid_id:
    :param item_id: param auction_id:
    :param info:
    :param raid_id:
    :param auction_id:
